...
import { DragDropManager, createDragDropManager, Identifier } from '@~sunsimiao/cj-dnd-core'
import { DndComponentClass, DndComponent } from './interfaces'
// import { Consumer } from './DragDropContext'
import {manager as dragDropManager} from './DragDropContext';
import {
	Disposable,
	CompositeDisposable,
	SerialDisposable,
} from './utils/disposables'
import createHTML5Backend from '@~sunsimiao/cj-dnd-backend'
...
// export const dragDropManager = createDragDropManager(createHTML5Backend, {})
