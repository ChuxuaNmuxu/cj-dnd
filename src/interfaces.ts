...
import { XYCoord, DragDropMonitor, Identifier, DragDropManager } from '@~sunsimiao/cj-dnd-core'
...
export interface DragSourceSpec<Props, DragObject> {
	 ...
	 */
	endDrag?: (props: Props, monitor: any, component: any) => void
	 ...
	 */
	canDrag?: (props: Props, monitor: any) => boolean
	 ...
	 */
	isDragging?: (props: Props, monitor: any) => boolean
}
